...
function loadECSConfig(): ECSConfig | null {
  ...
  return {
    ...
    privateSubnetIds: requiredEnv("PRIVATE_SUBNET_IDS")
      .split(",")
      .map((s) => s.trim()),
    gatewaySecurityGroupId: requiredEnv("GATEWAY_SECURITY_GROUP_ID"),
    ...
    cpu: process.env.GATEWAY_CPU ?? "256",
    memory: process.env.GATEWAY_MEMORY ?? "512",
        ...
        new CreateServiceCommand({
          ...
          networkConfiguration: {
            awsvpcConfiguration: {
              ...
              securityGroups: [cfg.gatewaySecurityGroupId],
